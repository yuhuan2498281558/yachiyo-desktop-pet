...
- 增加有大小上限的本地诊断日志，覆盖 Codex 状态、形态切换、动画与配置错误。
...
- 若继续可靠性改造，下一步是将 renderer 的并发动画控制抽成轻量 Sprite 动作队列。若继续 Live2D，从中性全身定稿和半身最小可动样机开始；规格位于 `D:\桌宠\资料\Live2D工程\八千代\00-规格与索引\八千代Live2D模型规格与参考帧索引.md`。
