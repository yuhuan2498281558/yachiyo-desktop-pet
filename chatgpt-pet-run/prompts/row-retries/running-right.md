Create Codex pet row `running-right` for `yachiyo`: exactly 8 full-body frames in one horizontal strip on flat pure yellow #FFFF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: 八千代 Q 版银白双马尾虚拟歌姬；双环发饰，青粉挑染，深海军蓝和风宽袖，青绿色层叠裙，洋红章鱼胸饰；清晰现代二维动画贴纸风，保持同一人物、服装和比例。. Preserve silhouette, face, palette, material, proportions, markings, and props.
